/* elcgtim.c - time the elcg RNG  Version 1.0.0                      */
...
int main(void)
   ...
   printf("elcg                 count %.0f ticks %d\n",
      count, elap);
   /**************************************************/
   /* time the glibc drand48 RNG                     */
   /**************************************************/
   /* initialize the glibc drand48 RNG               */
   /* to date, time, #ticks                          */
   /**************************************************/
   ...
   /* initialize the glibc drand48 random number generator */
   /* to date,time,#ticks                                  */
   srand48(dttk);
   /**************************************************/
   count = 0.0;
   ...
   printf("glibc drand48        count %.0f ticks %d\n",
      count, elap);
   /**************************************************/
   /* time the glibc lrand48 RNG                     */
   /**************************************************/
   /* initialize the glibc lrand48 RNG               */
   /* to date, time, #ticks                          */
   /**************************************************/
   /* get clock ticks since boot                           */
   clk = times(&t);
   ...
   /* combine date, time, and ticks into a single UINT     */
   dttk = (unsigned int) (now ^ clk);
   /* initialize the glibc lrand48 random number generator */
   /* to date,time,#ticks                                  */
   srand48(dttk);
   /**************************************************/
   count = 0.0;
   ...
   printf("glibc lrand48        count %.0f ticks %d\n",
      count, elap);
   /**************************************************/
